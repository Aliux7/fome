...
const CTASection = () => {
  return (
    <FadeSlide className="relative w-full flex items-center justify-center p-10 pt-40">
      <div className="relative w-full h-96 3xl:h-120 rounded-2xl overflow-hidden shadow-xl">
        <Image
          src={background_cta}
          alt=""
          fill
        ...
        <div className="relative z-30 h-full  flex items-center justify-end px-14">
          <div className="max-w-xl 3xl:max-w-none text-right text-white">
            <h2 className="text-4xl xl:text-5xl 3xl:text-6xl font-bold leading-tight font-satoshi">
              Made By You
            </h2>
            <h2 className="text-4xl xl:text-5xl 3xl:text-6xl font-bold mb-6 leading-tight font-satoshi">
              Meant For You
            </h2>

            <p className="xl:text-lg 3xl:text-xl text-zinc-200 mb-8 text-balance xl:text-nowrap">
